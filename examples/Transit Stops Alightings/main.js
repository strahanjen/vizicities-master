...
function updateMap() {
  ...
  layer =  "Fall2015TransitStopsAvgDailyOffs_grid.geojson";
    ...
    var colourScale = chroma.scale('YlOrBr').domain([0,300]);  //update the domain to match the domain of values in our data
    ...
    //VIZI.geoJSONLayer('dthousinginventory.geojson', {
      ...
      style: function(feature) {
        ...
        if (feature.properties.Offs_int_s) {
    ...
    */
          height = feature.properties.Offs_int_s;
