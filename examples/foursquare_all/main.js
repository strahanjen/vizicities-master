...
function updateMap() {
  ...
  layer =  "foursquarecheckins_all.geojson";
    ...
    var colourScale = chroma.scale('YlOrBr').domain([1,990]);  //update the domain to match the domain of values in our data
    ...
    */
          ...
          height = feature.properties.checkins_s * .055;
