...
function updateMap() {
  ...
  layer =  "restaurantbarcheckins_all.geojson";
    ...
    var colourScale = chroma.scale('YlOrBr').domain([1,1181]);  //update the domain to match the domain of values in our data
    ...
    //VIZI.geoJSONLayer('dthousinginventory.geojson', {
      ...
      style: function(feature) {
        ...
        if (feature.properties.checkins_s) {
    ...
    */
          height = feature.properties.checkins_s * .075;
